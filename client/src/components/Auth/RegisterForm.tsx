...
const RegisterForm = () => {
  ...
  if (!role) {
    return (
      <div className="flex justify-center items-center min-h-screen px-4">
        <Card className="w-full max-w-md shadow-xl rounded-2xl text-center p-6">
          <CardHeader>
            <CardTitle className="text-2xl font-bold mb-2">Choose Your Role</CardTitle>
            <p className="text-gray-500">Select whether you are a Student or a Teacher</p>
          </CardHeader>
          <CardContent className="flex flex-col gap-4 mt-4">
            ...
            <Button
              ...
              className="w-full flex items-center justify-center gap-2"
            >
              <Briefcase className="w-5 h-5" /> I am a Teacher
            </Button>
          </CardContent>
        </Card>
      </div>
